    ...
    <div className="container mx-auto p-4 space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Exploring in demo mode - all features are functional but data won't be saved
          </p>
        </div>
        <Button asChild>
          ...
          <Card>
            ...
            <CardFooter>
              <div className="w-full text-center">
                <p className="text-sm text-muted-foreground">This is a demo version. Settings changes are not saved.</p>
              </div>
            </CardFooter>
          </Card>
        </TabsContent>
      ...
      <div className="mt-8 p-4 bg-muted rounded-lg">
        ...
        <p className="text-sm text-muted-foreground mb-2">
          You're exploring the dashboard in demo mode. All features are fully functional with sample data.
        </p>
        <p className="text-sm text-muted-foreground">
          In this demo, you can explore all features without restrictions. Any changes you make will be simulated but
